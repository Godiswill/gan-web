...
export const exampleImgs = [
  {
    src: 'https://cdn.bgg.one/remove-bg/car.jpg',
    alt: 'Car | AI Background Remover - BgGone',
  },
  {
    src: 'https://cdn.bgg.one/remove-bg/dog.jpg',
    alt: 'Pet | AI Background Removal - BgGone',
  },
  {
    src: 'https://cdn.bgg.one/remove-bg/eagle.jpg',
    alt: 'Animal | AI Remove Background - BgGone',
  },
  {
    src: 'https://cdn.bgg.one/remove-bg/love.jpg',
    alt: 'People | AI Remove the Background of people - BgGone',
  },
  {
    src: 'https://cdn.bgg.one/remove-bg/motorcycle.jpg',
    alt: 'Sports | AI Remove Bg - BgGone',
  },
];
